      ...
      <Row>
        <Col md={6} sm={12}>
          <RouterLink to='interesses' onClick={() => setPerfil('cliente')}>
            <img src={cliente} alt="" />
            <Tipografia variante='body' componente='body'>Eu sou cliente e preciso de um freela!</Tipografia>
          </RouterLink>
        </Col>
        <Col md={6} sm={12}>
          <img src={freelancer} alt="" />
          <Tipografia variante='body' componente='body'>Eu sou um freela e preciso de um cliente!</Tipografia>
        </Col>
      </Row>
